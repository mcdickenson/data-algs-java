...
I do not know of any bugs in the code, other than it throws an error if you open the load url dialog and then hit "cancel" (this throws some errors but doesn't stop the program).
